...
The navigation is generated from your pages! [`<AppNavbar>`](https://github.com/Atinux/content-wind/blob/main/components/AppNavbar.vue)


[Navigation](https://content.nuxt.com/usage/navigation) from Nuxt Content to fetch the navigation object.

To customize the title set the `navigation.title` property in the front-matter of your pages
...
Vue components go in  the `components/content/` directory.
