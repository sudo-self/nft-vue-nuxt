...
github pages deployed with&nbsp;&nbsp;:sparkles:[Nuxt Studio](http://sudo-self-content-wind.nuxt.space/)

One click publish with vercel
...
can publish the /dist folder with and static host.
